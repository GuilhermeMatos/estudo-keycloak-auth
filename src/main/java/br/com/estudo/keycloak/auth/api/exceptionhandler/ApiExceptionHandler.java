...
import br.com.estudo.keycloak.auth.domain.exception.AcessoNaoAutorizadoException;
import br.com.estudo.keycloak.auth.domain.exception.AcessoNegadoException;
import br.com.estudo.keycloak.auth.domain.exception.AplicacaoException;
import br.com.estudo.keycloak.auth.domain.exception.ConflitoException;
import br.com.estudo.keycloak.auth.domain.exception.RecursoNaoEncontradoException;
import br.com.estudo.keycloak.auth.domain.exception.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErroDTO> handlerAcessoNegadoExceptions(AcessoNegadoException ex, WebRequest request) {
	...
	public ResponseEntity<ErroDTO> handlerAcessoNegadoExceptions(AccessDeniedException ex, WebRequest request) {
		log.error("Ocorreu um erro de acesso: ", ex);
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		Set<ErroDTO.Validacao> validacoes = ex.getBindingResult().getFieldErrors().stream()
				.map(campo -> {
